...
import { layDanhSachPhimAction, xoaPhimAction } from '../../../store/Actions/QuanLyPhimAction';
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, film, index) => {
                return <Fragment>
                    <img src={film.hinhAnh} alt={film.tenPhim} width={60} height={60} onError={(e) => { e.target.onError = null; e.target.src = `https://picsum.photos/id/${index}/50/50` }} />
                </Fragment>
            },
            width: '15%'
        ...
        },
        {
            ...
            render: (text, film) => {
                return <Fragment>
                    <NavLink key={1} className=" mr-2  text-2xl" to={`/admin/edit/${film.maPhim}`}><EditOutlined style={{ color: 'blue' }} /> </NavLink>
