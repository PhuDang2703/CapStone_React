...
import { capNhatPhimUploadAction, layThongTinPhimAction, themPhimUploadHinhAction } from '../../../../store/Actions/QuanLyPhimAction';
...
const Edit = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(layThongTinPhimAction(params.id));
  }, [])
