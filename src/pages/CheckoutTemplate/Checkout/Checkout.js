...
import { datVeAction, datGheAction, layChiTietPhongVeAction } from '../../../store/Actions/QuanLyDatVeAction';
  ...
  return (
    <div className=" min-h-screen mt-5" >
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-3 mr-5 mt-5">

          <hr />
          <h3 className="text-2xl mt-2 text-blue-700">{thongTinPhim.tenPhim}</h3>
          ...
          <div className="flex flex-row my-5">
            <div className="w-4/5">
              ...
              {/* Lodash sortBy để sắp xếp thứ tự số ghế */}
          ...
          <h3 className="text-green-500 text-center text-4xl"> {danhSachGheDangDat.reduce((tongTien, ghe, index) => {
            return tongTien += ghe.giaVe;
          ...
          <div className="mb-0 h-full flex flex-col items-center" style={{ marginBottom: 0 }}>
            ...
            }} className="bg-green-700 text-white w-full text-center py-3 font-bold text-2xl cursor-pointer">
              ĐẶT VÉ
            </div>
          </div>
        </div>
