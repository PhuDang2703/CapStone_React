      ...
      <header className="p-4 dark:bg-gray-800 dark:text-gray-100 bg-opacity-40 bg-black text-white fixed w-full z-10">
        <div className="container flex justify-between h-16 mx-auto">
          <NavLink rel="noopener noreferrer" to='/' aria-label="Back to homepage" className="flex items-center p-2">
            <img style={{width:265, height:90}} src="https://mybk.hcmut.edu.vn/my/images/logo.png" alt='logo' />
          ...
          <ul className="items-stretch hidden space-x-3 lg:flex">
            <li className="flex">
              <NavLink rel="noopener noreferrer" to="/" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400" activeClassName='border-b-2 border-white'>Home</NavLink>
            </li>
            <li className="flex">
              <NavLink rel="noopener noreferrer" to="about" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent" activeClassName='border-b-2 border-white'>About</NavLink>
            </li>
            <li className="flex">
              <NavLink rel="noopener noreferrer" to="listmovie" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent" activeClassName='border-b-2 border-white'>List Movie</NavLink>
            </li>
            <li className="flex">
              <NavLink rel="noopener noreferrer" to="checkout" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">News</NavLink>
            </li>
          </ul>
